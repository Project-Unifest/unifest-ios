...
enum StringLiterals {
    ...
    enum Home {
        ...
        static let noFestivalMessage = "오늘은 축제가 열리지 않아요"
    ...
    enum Map {
        ...
        static let drinkBoothTitle = "주점" // "체험"
        static let foodBoothTitle = "먹거리" // "푸드트럭"
        static let eventBoothTitle = "이벤트" // "교내"
        static let generalBoothTitle = "일반" // "교외"
